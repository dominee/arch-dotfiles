# Generated by Powerlevel10k configuration wizard on 2024-05-31 at 16:09 CEST.
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=237 #domine
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=236  #dominee
  ...
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=063 #dominee
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=012 #dominee
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=63 #dominee
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      # Styling for up-to-date Git status. # dominee - altered
      local       meta='%246F'  # grey foreground
      local      clean='%253F'   # green foreground
      local   modified='%63F'  # yellow foreground
      local  untracked='%69F'   # blue foreground
  ...
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=255 # dominee
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=63 #dominee
  ...
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=12 #dominee
